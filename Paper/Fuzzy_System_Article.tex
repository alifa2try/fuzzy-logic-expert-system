...
\Abstract{Report of our implementation of a fuzzy logic system, which is made with the python scikit-fuzzy library. This is a great library for implementing a fuzzy logic system in Python. It is easy to use, secure, well documented and easy customizable. It has one flaw, its performance is bad. It uses NumPy and is completely written in Python, which is a bad formula for big data sets.}
